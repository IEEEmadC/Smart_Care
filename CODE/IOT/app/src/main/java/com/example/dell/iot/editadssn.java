...
public class editadssn extends AppCompatDialogFragment {
    String name_u;
    String name_s;
    String email_s;
    String email_u;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.editsad,null);
        ...
        t1 = (EditText) view.findViewById(R.id.txEdits);
        t2 = (EditText) view.findViewById(R.id.txDeletes);
        t3 = (EditText) view.findViewById(R.id.txSends);
        t1.setText(name_s);
        t2.setText(email_s);
        t3.setText(phone_s);
        ...
        builder.setView(view).setTitle("Edit Supervisor").setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(!n2.equals(email_s)){email_n = n2;}
                else email_n="null";
                name_s = n1;
                phone_s = n3;
                edit_super();
    ...
    private void edit_super() {
        // Tag used to cancel the request
        String tag_string_req = "req_user";
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.SUPEER_URL, new Response.Listener<String>() {
            @Override
